...
class OurGame(arcade.Window):
    ...
    def setup(self):
        ...
        for i in range(5):
            column_top = ColumnTop("resources/column_bottom.png", 1)
    ...
    def on_update(self, delta_time: float):
        ...
        if not self.stop:
            ...
            hit_list = arcade.check_for_collision_with_list(self.player, self.colums_list)
            if len(hit_list) > 0:
                self.player.stop()
