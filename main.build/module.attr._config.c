...
static PyCodeObject *codeobj_0315a7312b2f395da5bd6b01fc248f23;
static PyCodeObject *codeobj_be623198306de26326aeb36c4f33bbda;
static PyCodeObject *codeobj_2fc38c7eb21b1ae878e7b8c55cd070e8;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[13]); CHECK_OBJECT(module_filename_obj);
    codeobj_0315a7312b2f395da5bd6b01fc248f23 = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[14], mod_consts[14], NULL, NULL, 0, 0, 0);
    codeobj_be623198306de26326aeb36c4f33bbda = MAKE_CODE_OBJECT(module_filename_obj, 23, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[11], mod_consts[11], NULL, NULL, 0, 0, 0);
    codeobj_2fc38c7eb21b1ae878e7b8c55cd070e8 = MAKE_CODE_OBJECT(module_filename_obj, 9, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[10], mod_consts[10], mod_consts[15], NULL, 1, 0, 0);
}
...
static PyObject *impl_attr$_config$$$function__1_set_run_validators(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    struct Nuitka_FrameObject *frame_2fc38c7eb21b1ae878e7b8c55cd070e8;
    ...
    static struct Nuitka_FrameObject *cache_frame_2fc38c7eb21b1ae878e7b8c55cd070e8 = NULL;
    PyObject *tmp_return_value = NULL;

    // Actual function body.
    if (isFrameUnusable(cache_frame_2fc38c7eb21b1ae878e7b8c55cd070e8)) {
        Py_XDECREF(cache_frame_2fc38c7eb21b1ae878e7b8c55cd070e8);

#if _DEBUG_REFCOUNTS
        if (cache_frame_2fc38c7eb21b1ae878e7b8c55cd070e8 == NULL) {
...
#endif
        cache_frame_2fc38c7eb21b1ae878e7b8c55cd070e8 = MAKE_FUNCTION_FRAME(tstate, codeobj_2fc38c7eb21b1ae878e7b8c55cd070e8, module_attr$_config, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    assert(cache_frame_2fc38c7eb21b1ae878e7b8c55cd070e8->m_type_description == NULL);
    frame_2fc38c7eb21b1ae878e7b8c55cd070e8 = cache_frame_2fc38c7eb21b1ae878e7b8c55cd070e8;

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_2fc38c7eb21b1ae878e7b8c55cd070e8);
    assert(Py_REFCNT(frame_2fc38c7eb21b1ae878e7b8c55cd070e8) == 2);
    ...
    branch_yes_1:;
    {
        ...
        frame_2fc38c7eb21b1ae878e7b8c55cd070e8->m_frame.f_lineno = 18;
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_2fc38c7eb21b1ae878e7b8c55cd070e8, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_2fc38c7eb21b1ae878e7b8c55cd070e8->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_2fc38c7eb21b1ae878e7b8c55cd070e8, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_2fc38c7eb21b1ae878e7b8c55cd070e8,
        type_description_1,
        par_run
    );
    ...
    if (frame_2fc38c7eb21b1ae878e7b8c55cd070e8 == cache_frame_2fc38c7eb21b1ae878e7b8c55cd070e8) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif
        Py_DECREF(cache_frame_2fc38c7eb21b1ae878e7b8c55cd070e8);
        cache_frame_2fc38c7eb21b1ae878e7b8c55cd070e8 = NULL;
    }

    assertFrameObject(frame_2fc38c7eb21b1ae878e7b8c55cd070e8);
...
static PyObject *impl_attr$_config$$$function__2_get_run_validators(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Local variable declarations.
    struct Nuitka_FrameObject *frame_be623198306de26326aeb36c4f33bbda;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    PyObject *tmp_return_value = NULL;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    PyTracebackObject *exception_tb = NULL;
    NUITKA_MAY_BE_UNUSED int exception_lineno = 0;
    static struct Nuitka_FrameObject *cache_frame_be623198306de26326aeb36c4f33bbda = NULL;

    // Actual function body.
    if (isFrameUnusable(cache_frame_be623198306de26326aeb36c4f33bbda)) {
        Py_XDECREF(cache_frame_be623198306de26326aeb36c4f33bbda);

#if _DEBUG_REFCOUNTS
        if (cache_frame_be623198306de26326aeb36c4f33bbda == NULL) {
            count_active_frame_cache_instances += 1;
        } else {
            count_released_frame_cache_instances += 1;
        }
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_be623198306de26326aeb36c4f33bbda = MAKE_FUNCTION_FRAME(tstate, codeobj_be623198306de26326aeb36c4f33bbda, module_attr$_config, 0);
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    assert(cache_frame_be623198306de26326aeb36c4f33bbda->m_type_description == NULL);
    frame_be623198306de26326aeb36c4f33bbda = cache_frame_be623198306de26326aeb36c4f33bbda;

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_be623198306de26326aeb36c4f33bbda);
    assert(Py_REFCNT(frame_be623198306de26326aeb36c4f33bbda) == 2);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_be623198306de26326aeb36c4f33bbda, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_be623198306de26326aeb36c4f33bbda->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_be623198306de26326aeb36c4f33bbda, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_be623198306de26326aeb36c4f33bbda,
        type_description_1
    );


    // Release cached frame if used for exception.
    if (frame_be623198306de26326aeb36c4f33bbda == cache_frame_be623198306de26326aeb36c4f33bbda) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif
        Py_DECREF(cache_frame_be623198306de26326aeb36c4f33bbda);
        cache_frame_be623198306de26326aeb36c4f33bbda = NULL;
    }

    assertFrameObject(frame_be623198306de26326aeb36c4f33bbda);
...
static PyObject *MAKE_FUNCTION_attr$_config$$$function__1_set_run_validators() {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        codeobj_2fc38c7eb21b1ae878e7b8c55cd070e8,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
...
static PyObject *MAKE_FUNCTION_attr$_config$$$function__2_get_run_validators() {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        codeobj_be623198306de26326aeb36c4f33bbda,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_0315a7312b2f395da5bd6b01fc248f23;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    bool tmp_result;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    ...
    frame_0315a7312b2f395da5bd6b01fc248f23 = MAKE_MODULE_FRAME(codeobj_0315a7312b2f395da5bd6b01fc248f23, module_attr$_config);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_0315a7312b2f395da5bd6b01fc248f23);
    assert(Py_REFCNT(frame_0315a7312b2f395da5bd6b01fc248f23) == 2);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_0315a7312b2f395da5bd6b01fc248f23, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_0315a7312b2f395da5bd6b01fc248f23->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_0315a7312b2f395da5bd6b01fc248f23, exception_lineno);
    }



    assertFrameObject(frame_0315a7312b2f395da5bd6b01fc248f23);
