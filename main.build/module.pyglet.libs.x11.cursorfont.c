...
static PyCodeObject *codeobj_b6a55f341d23b24bf06aa598674314f1;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[162]); CHECK_OBJECT(module_filename_obj);
    codeobj_b6a55f341d23b24bf06aa598674314f1 = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[163], mod_consts[163], NULL, NULL, 0, 0, 0);
}
...
function_impl_code functable_pyglet$libs$x11$cursorfont[] = {
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    function_impl_code *current = functable_pyglet$libs$x11$cursorfont;
    int offset = 0;
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (offset > sizeof(functable_pyglet$libs$x11$cursorfont) || offset < 0) {
    ...
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        functable_pyglet$libs$x11$cursorfont[offset],
        code_object->co_name,
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_b6a55f341d23b24bf06aa598674314f1;
    ...
    frame_b6a55f341d23b24bf06aa598674314f1 = MAKE_MODULE_FRAME(codeobj_b6a55f341d23b24bf06aa598674314f1, module_pyglet$libs$x11$cursorfont);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_b6a55f341d23b24bf06aa598674314f1);
    assert(Py_REFCNT(frame_b6a55f341d23b24bf06aa598674314f1) == 2);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_b6a55f341d23b24bf06aa598674314f1, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_b6a55f341d23b24bf06aa598674314f1->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_b6a55f341d23b24bf06aa598674314f1, exception_lineno);
    }



    assertFrameObject(frame_b6a55f341d23b24bf06aa598674314f1);
