...
static PyCodeObject *codeobj_92fb50ff971c72a76ba9fb0a92a86408;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[302]); CHECK_OBJECT(module_filename_obj);
    codeobj_92fb50ff971c72a76ba9fb0a92a86408 = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[303], mod_consts[303], NULL, NULL, 0, 0, 0);
}
...
function_impl_code functable_arcade$csscolor[] = {
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    function_impl_code *current = functable_arcade$csscolor;
    int offset = 0;
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (offset > sizeof(functable_arcade$csscolor) || offset < 0) {
    ...
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        functable_arcade$csscolor[offset],
        code_object->co_name,
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_92fb50ff971c72a76ba9fb0a92a86408;
    ...
    frame_92fb50ff971c72a76ba9fb0a92a86408 = MAKE_MODULE_FRAME(codeobj_92fb50ff971c72a76ba9fb0a92a86408, module_arcade$csscolor);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_92fb50ff971c72a76ba9fb0a92a86408);
    assert(Py_REFCNT(frame_92fb50ff971c72a76ba9fb0a92a86408) == 2);
    ...
    // Framed code:
    {
        ...
        frame_92fb50ff971c72a76ba9fb0a92a86408->m_frame.f_lineno = 1;
        {
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_92fb50ff971c72a76ba9fb0a92a86408, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_92fb50ff971c72a76ba9fb0a92a86408->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_92fb50ff971c72a76ba9fb0a92a86408, exception_lineno);
    }



    assertFrameObject(frame_92fb50ff971c72a76ba9fb0a92a86408);
