...
static PyCodeObject *codeobj_34997028bc28e34b963c3de8e5dfbb44;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[391]); CHECK_OBJECT(module_filename_obj);
    codeobj_34997028bc28e34b963c3de8e5dfbb44 = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[392], mod_consts[392], NULL, NULL, 0, 0, 0);
}
...
function_impl_code functable_arcade$key[] = {
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    function_impl_code *current = functable_arcade$key;
    int offset = 0;
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (offset > sizeof(functable_arcade$key) || offset < 0) {
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_34997028bc28e34b963c3de8e5dfbb44;
    ...
    frame_34997028bc28e34b963c3de8e5dfbb44 = MAKE_MODULE_FRAME(codeobj_34997028bc28e34b963c3de8e5dfbb44, module_arcade$key);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_34997028bc28e34b963c3de8e5dfbb44);
    assert(Py_REFCNT(frame_34997028bc28e34b963c3de8e5dfbb44) == 2);
    ...
    // Framed code:
    {
        ...
        frame_34997028bc28e34b963c3de8e5dfbb44->m_frame.f_lineno = 1;
        {
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_34997028bc28e34b963c3de8e5dfbb44, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_34997028bc28e34b963c3de8e5dfbb44->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_34997028bc28e34b963c3de8e5dfbb44, exception_lineno);
    }



    assertFrameObject(frame_34997028bc28e34b963c3de8e5dfbb44);
